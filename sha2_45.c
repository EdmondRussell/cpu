...
int scanhash_sha256d(int thr_id, struct work *work, uint32_t max_nonce, uint64_t *hashes_done)
{
	...
	// String dynamics (DIFFERENT INITIAL CONDITIONS)
	static double string_tension = 0.8;   // Lower initial tension
	static double coupling_gs = 0.15;     // Higher initial coupling
	static double dilaton_field = -1.9;   // Different dilaton
	static double worldsheet_area = 0.0;
	
	// Calabi-Yau manifold (THE WINNER)
	static double calabi_yau_volume = 0.9;  // Lower starting volume
